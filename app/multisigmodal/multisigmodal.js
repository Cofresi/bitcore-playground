...
angular.module('playApp.multisigmodal', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/multisigmodal', {
    templateUrl: 'multisigmodal/multisigmodal.html',
    controller: 'MultisigModalCtrl'
  });
}])

.controller('MultisigModalCtrl', function($scope, bitcore) {
